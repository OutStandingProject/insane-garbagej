  ...
  return (
    ...
    >
      <div className="relative w-[90%] h-[90%] flex items-center justify-center overflow-hidden">
        <div className="relative w-full h-full flex items-center justify-center border-[8px] border-solid border-4B bg-4B rounded-[2.2rem] overflow-hidden">
          <div className="relative w-full h-full flex border-[10px] border-solid border-0B bg-0B rounded-[2.2rem] overflow-hidden">
            <div
              className="relative flex flex-col w-full h-full overflow-hidden bg-cover"
              style={{ backgroundImage: "url(images/ipad_bg.png)" }}
            >
              {/* ── macOS-style top bar ── */}
              <div
                className="relative flex items-center z-10 px-4"
                style={{
                  minHeight: "32px",
                  background:
                    "linear-gradient(180deg, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.55) 100%)",
                  borderBottom: "1px solid rgba(255,255,255,0.06)",
                }}
              >
                {/* Left: traffic lights + app name + menu */}
                <div className="flex items-center gap-3 flex-1 overflow-hidden">
                  ...
                  {/* Menu items — todas as funções reais do script */}
                  <ul className="flex items-center gap-3 overflow-hidden select-none whitespace-nowrap">
                    <li>
                      <span className="text-xs font-medium text-white/70 hover:text-white cursor-default transition-colors">
                        {t("file")}
                      </span>
                    </li>
                    <li>
                ...
                <div className="absolute left-1/2 -translate-x-1/2 flex justify-center pointer-events-none">
                  <img src="images/celtik.png" alt="celtik" className="h-5 opacity-70" />
                </div>
